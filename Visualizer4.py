...
class Visualizer4:
    ...
    """
    def plot_genre_comparison_animated(self, director_data):
        """
        ...
        """
        directors = director_data['genres']
        ...
        ax.set_title('Average Ratings of All Movies by Genre', fontsize=18, fontweight='bold', pad=10)
